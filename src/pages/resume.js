                                ...
                                <div className="css-1skky35">
                                    ...
                                    <div className="css-o60zcr">
                                        ...
                                        <div className="css-1s9109j">
                                            <p className="chakra-text css-ak2fvk" style={{ transform: `translateX(-149.937deg) translateZ(0px) `, animation:`translateX 30s linear infinite`}}>Maintain existing products</p>
                                        </div>
                                    </div>
                                            ...
                                            <div className="css-q93ar1">
                                                ...
                                                <div className="css-93mbcm">
                                                    <div spacing="5" className="css-1f847os" style={{ transform: `translateX(-765.665px) translateZ(0px)`, animation:`translateX 30s linear infinite`}}>
                                                        <p className="chakra-text css-16w502t" ><Text fontSize='24px' color='white'>Maintain existing products</Text></p>
                                                        <p className="chakra-text css-16w502t" ><Text fontSize='24px' color='white'>Agile development experience</Text></p>
                                                        <p className="chakra-text css-16w502t" ><Text fontSize='24px' color='white'>Automated testing experience</Text></p>
                                                        <p className="chakra-text css-16w502t" ><Text fontSize='24px' color='white'>Good programming habits</Text></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
